...
**Note: This is not my original work. I followed this [guide](https://anderfernandez.com/en/blog/code-knn-in-r/).**
...
* Make the prediction based on a weighted average that has takem into account the distance of the rest of the observations with respect to target, in such a way that those observations that are closer have more weight than those that are further away.
